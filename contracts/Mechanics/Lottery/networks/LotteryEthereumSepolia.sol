...
contract LotteryEthereumSepolia is Lottery, ChainLinkEthereumSepoliaV2Plus {
  constructor(
    LotteryConfig memory config
  ) Lottery(config) ChainLinkEthereumSepoliaV2Plus(uint16(6), uint32(600000), uint32(1)) {}
