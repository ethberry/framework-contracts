...
contract ERC721GenesBinance is ERC721Genes, ChainLinkBinanceV2Plus {
  constructor(
    string memory name,
    string memory symbol,
    uint96 royalty,
    string memory baseTokenURI
  ) ERC721Genes(name, symbol, royalty, baseTokenURI) ChainLinkBinanceV2Plus(uint16(6), uint32(600000), uint32(1)) {}
