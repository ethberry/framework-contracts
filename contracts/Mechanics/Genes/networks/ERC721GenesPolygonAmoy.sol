...
contract ERC721GenesPolygonAmoy is ERC721Genes, ChainLinkPolygonAmoyV2Plus {
  constructor(
    string memory name,
    string memory symbol,
    uint96 royalty,
    string memory baseTokenURI
  ) ERC721Genes(name, symbol, royalty, baseTokenURI) ChainLinkPolygonAmoyV2Plus(uint16(6), uint32(600000), uint32(1)) {}
