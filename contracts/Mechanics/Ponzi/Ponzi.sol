...
import { CoinHolder, NativeRejector, CoinHolder } from "@ethberry/contracts-finance/contracts/Holder.sol";
...
contract Ponzi is IPonzi, AccessControl, Pausable, Referral, CoinHolder, NativeRejector, TopUp, ReentrancyGuard {
