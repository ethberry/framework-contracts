...
contract ERC721BlacklistRentable is ERC721Blacklist, ERC4907 {
  ...
  function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Blacklist, ERC4907) returns (bool) {
  ...
  function _update(
    ...
    uint256 tokenId,
    address auth
  ) internal virtual override(ERC721Blacklist, ERC4907) returns (address) {
