...
import { ERC4907 } from "@ethberry/contracts-erc721/contracts/extensions/ERC4907.sol";
...
import { ERC721Discrete } from "../Discrete/ERC721Discrete.sol";
...
contract ERC721DiscreteRentable is ERC721Discrete, ERC4907 {
   ...
   */
  function supportsInterface(bytes4 interfaceId) public view virtual override(ERC721Discrete, ERC4907) returns (bool) {
  ...
  function _update(
    ...
    uint256 tokenId,
    address auth
  ) internal virtual override(ERC721ABER, ERC4907) returns (address) {
