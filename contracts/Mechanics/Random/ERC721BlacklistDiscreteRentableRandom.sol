...
import { ERC721BlacklistDiscreteRentable } from "../Rentable/ERC721BlacklistDiscreteRentable.sol";

abstract contract ERC721BlacklistDiscreteRentableRandom is IERC721Random, ERC721BlacklistDiscreteRentable, Rarity {
  struct Request {
    address account;
    uint256 templateId;
  }
