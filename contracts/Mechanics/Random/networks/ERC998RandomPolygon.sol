...
contract ERC998RandomPolygon is ERC998Random, ChainLinkPolygonV2Plus {
  constructor(
    string memory name,
    string memory symbol,
    uint96 royalty,
    string memory baseTokenURI
  ) ERC998Random(name, symbol, royalty, baseTokenURI) ChainLinkPolygonV2Plus(uint16(6), uint32(600000), uint32(1)) {}
