...
contract RaffleEthereumSepolia is Raffle, ChainLinkEthereumSepoliaV2Plus {
  constructor() Raffle() ChainLinkEthereumSepoliaV2Plus(uint16(6), uint32(600000), uint32(1)) {}
