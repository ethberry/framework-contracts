...
contract LotteryRandomEthereumSepolia is LotteryRandom, ChainLinkEthereumSepoliaV2Plus {
  constructor(
    LotteryConfig memory config
  ) LotteryRandom(config) ChainLinkEthereumSepoliaV2Plus(uint16(6), uint32(600000), uint32(1)) {}
