...
import { ChainLinkBinanceTestnetV2Plus } from "@ethberry/contracts-chain-link-v2-plus/contracts/extensions/ChainLinkBinanceTestnetV2Plus.sol";
...
contract RaffleRandomBinanceTestnet is RaffleRandom, ChainLinkBinanceTestnetV2Plus {
  constructor() RaffleRandom() ChainLinkBinanceTestnetV2Plus(uint16(6), uint32(600000), uint32(1)) {}
