...
contract ERC721Wotes is ERC721Simple, ERC721Votes {
  constructor(
    string memory name,
   ...
   */
  function _update(address to, uint256 tokenId, address auth) internal virtual override(ERC721ABER, ERC721Votes) returns (address) {
