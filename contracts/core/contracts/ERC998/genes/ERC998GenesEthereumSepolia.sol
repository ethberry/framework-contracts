...
import { ChainLinkEthereumSepoliaV2Plus } from "@gemunion/contracts-chain-link-v2-plus/contracts/extensions/ChainLinkEthereumSepoliaV2Plus.sol";
...
contract ERC998GenesEthereumSepolia is ERC998Genes, ChainLinkEthereumSepoliaV2Plus {
  constructor(
    string memory name,
    string memory symbol,
    uint96 royalty,
    string memory baseTokenURI
  ) ERC998Genes(name, symbol, royalty, baseTokenURI) ChainLinkEthereumSepoliaV2Plus(uint16(6), uint32(600000), uint32(1)) {}
