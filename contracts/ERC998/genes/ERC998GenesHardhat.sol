...
contract ERC998GenesHardhat is ERC998Genes, ChainLinkHardhatV2Plus {
  constructor(
    string memory name,
    string memory symbol,
    uint96 royalty,
    string memory baseTokenURI
  ) ERC998Genes(name, symbol, royalty, baseTokenURI) ChainLinkHardhatV2Plus(uint16(6), uint32(600000), uint32(1)) {}
