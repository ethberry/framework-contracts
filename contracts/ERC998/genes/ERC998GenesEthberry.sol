...
contract ERC998GenesEthberry is ERC998Genes, ChainLinkEthberryV2Plus {
  constructor(
    string memory name,
    string memory symbol,
    uint96 royalty,
    string memory baseTokenURI
  ) ERC998Genes(name, symbol, royalty, baseTokenURI) ChainLinkEthberryV2Plus(uint16(6), uint32(600000), uint32(1)) {}
