...
import { WhiteListChild } from "@ethberry/contracts-erc998td/contracts/extensions/WhiteListChild.sol";
import { IWhiteListChild } from "@ethberry/contracts-erc998td/contracts/interfaces/IWhiteListChild.sol";
...
contract ERC998Simple is ERC721Simple, ERC998ERC721, WhiteListChild {
  ...
  ) internal virtual override onlyWhiteListedWithDecrement(_childContract) {
  ...
  function receiveChild(
    ...
    address _childContract,
    uint256 _childTokenId
  ) internal virtual override onlyWhiteListedWithIncrement(_childContract) {
  ...
  function _update(
    ...
    uint256 tokenId,
    address auth
  ) internal virtual override(ERC721ABER, ERC998ERC721) returns (address) {
