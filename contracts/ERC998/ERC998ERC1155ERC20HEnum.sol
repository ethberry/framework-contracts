...
import { StateHash } from "@ethberry/contracts-erc998td/contracts/extensions/StateHash.sol";
import { ERC998ERC721 } from "@ethberry/contracts-erc998td/contracts/extensions/ERC998ERC721.sol";
import { ERC998ERC20 } from "@ethberry/contracts-erc998td/contracts/extensions/ERC998ERC20.sol";
import { ERC998ERC1155 } from "@ethberry/contracts-erc998td/contracts/extensions/ERC998ERC1155.sol";

import { ERC998SimpleEnum } from "./ERC998SimpleEnum.sol";

contract ERC998ERC1155ERC20HEnum is ERC998SimpleEnum, ERC998ERC1155Enumerable, ERC998ERC20Enumerable, StateHash {
  constructor(
    string memory name,
  ...
  function _balanceOfERC20(
    uint256 _tokenId,
    address _erc20Contract
  ) internal view override(StateHash, ERC998ERC20) returns (uint256) {
  ...
  function _update(
    ...
    uint256 tokenId,
    address auth
  ) internal virtual override(ERC721, ERC998SimpleEnum) returns (address) {
